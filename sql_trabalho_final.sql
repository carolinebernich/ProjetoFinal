...
bairro varchar(50) not null,
cidade varchar(50) not null,
curso varchar(100) not null references curso(nome_curso),
...
cod_termo numeric(6) not null primary key, 
...
cpf_aluno varchar(12) not null references estagiario(cpf),
nome_aluno varchar(100) not null references estagiario(nome),
nome_curso varchar(100) not null references curso(nome_curso), 
...
insert into termo_compromisso values(000001,"2020-08-20", "2021-06-26", 6.0, 30.0, "TI", "08:00:00", "14:00:00", 
									"Programação",1000.00, 500.00, "01000000110", "Matheus", 
                                    "Informática Biomédica","Luciano Costa Blomberg", "UFCSPA", "Lucia Campos Pellanda", "01254792215798",
                                    "SAP Labs Latin America", "Thomaz Ritter", "Desenvolvimento de Software e banco de dados"),
									(000002,"2020-06-12", "2021-04-22", 6.0, 30.0, "Biomedicina", "09:00:00", "15:00:00", 
									"Análise de dados",800.00, 600.00, "00880000808", "Carlos", 
                                    "Biomedicina - noturno","Melissa Medeiros Markoski", "UFCSPA", "Lucia Campos Pellanda", "47850025630087",
                                    "Hospital de Clínicas", "Igor Monza", "Buscar soluções cientificas para produzir medicamentos"),                                 
									(000003,"2020-02-05", "2021-08-18", 8.0, 40.0, "TI", "10:00:00", "18:00:00", 
									"Programação",1400.00, 800.00, "00990000909", "Poliana", 
                                    "Informática Biomédica","Luciano Costa Blomberg", "UFCSPA", "Lucia Campos Pellanda", "01254792215798",
                                    "SAP Labs Latin America", "Thomaz Ritter", "Desenvolvimento de Software e análise de dados"),
									(000004,"2019-12-22", "2021-06-26", 6.0, 30.0, "Biomedicina", "08:30:00", "14:30:00", 
									"Análise de dados",1000.00, 300.00, "00440000404", "Ronaldo", 
                                    "Biomedicina - diurno","Alessandra Peres", "UFCSPA", "Lucia Campos Pellanda", "24894792865478",
                                    "Hospital Moinhos de Vento", "Pamela Ferraza", "Buscar soluções cientificas para produzir medicamentos"),                                   
									(000005,"2020-11-07", "2021-08-02", 8.0, 40.0, "Fármacia", "07:00:00", "15:00:00", 
									"Produção de Medicamentos",1600.00, 600.00, "00770000707", "Bianca", 
                                    "Fármacia","Kellen Cristhinia Borges de Souza", "UFCSPA", "Lucia Campos Pellanda", "54896573010806",
                                    "Santa Casa de Misericórdia", "Jaqueline Sanches", "Separar, produzir e embalar medicamentos"),                                    
									(000006,"2020-05-09", "2021-01-14", 6.0, 30.0, "Psicologia", "09:30:00", "15:30:00", 
									"Atender pacientes",1200.00, 200.00, "00660000606", "Leticia", 
                                    "Psicologia","Mayte Raya Amazarray", "UFCSPA", "Lucia Campos Pellanda", "65732892214455",
                                    "PSICOCLIN", "André Justo", "Atendimento de pacientes, conusultas e relatórios"),                                    
									(000007,"2020-07-26", "2021-11-20", 6.0, 30.0, "Radiologia", "13:00:00", "19:00:00", 
									"Radioterapia", 800.00, 550.00, "00330000303", "Fernanda", 
                                    "Física Médica","Mirko Salomón Alva Sánchez", "UFCSPA", "Lucia Campos Pellanda", "47850025630087",
                                    "Hospital de Clínicas", "Igor Monza", "Processamento de imagens"),								
									(000008,"2020-09-15", "2021-05-01", 8.0, 40.0, "Enfermagem", "08:00:00", "14:00:00", 
									"Emergência",1000.00, 500.00, "00220000202", "Roberto", 
                                    "Enfermagem","Rita Catalina Aquino Caregnato", "UFCSPA", "Lucia Campos Pellanda", "54896573010806",
                                    "Santa Casa de Misericórdia", "Jaqueline Sanches", "Deverá atuar na areá de pronto socorro"),                                    
									(000009,"2021-01-15", "2022-01-15", 8.0, 40.0, "Medicina", "07:00:00", "15:00:00", 
									"Programação",1800.00, 900.00, "00550000505", "Vivian", 
                                    "Medicina","Paulo José Zimermann Teixeira", "UFCSPA", "Lucia Campos Pellanda", "24894792865478",
                                    "Hospital Moinhos de Vento", "Pamela Ferraza", "Prestar atenção nos outros médicos, relatar exames, cuidar de pacientes, etc..."),                                    
									(000010,"2021-03-29", "2022-03-29", 6.0, 30.0, "TI", "08:00:00", "14:00:00", 
									"Programação de banco de dados",800.00, 700.00, "00110000101", "João", 
                                    "Informática Biomédica","Luciano Costa Blomberg", "UFCSPA", "Lucia Campos Pellanda", "65732892214455",
                                    "PSICOCLIN", "André Justo", "Desenvolvimento de um banco de dados para os dados dos pacientes e das consultas");
